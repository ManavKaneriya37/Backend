    ...
    <div className='h-screen w-full flex flex-col justify-between p-2'>
      ...
      <h1 className='text-[32px] font-medium tracking-tight p-5'>Uber<i class='ri-arrow-right-line'></i></h1>
        ...
        <form onSubmit={(e) => {
          ...
          <p className='text-center mt-4 text-[16px]'>Already have a Captain Account? <Link to='/captain-login' className='text-blue-500'>Login</Link></p>
        </form>
      </div>

        <p className='text-center my-1 text-[11px]'>By signing up as an Uber Captain, you agree to Uber's <Link to='' className='text-blue-500'>Terms of Service</Link>, <Link to='' className='text-blue-500'>Conditions of Use</Link>, and <Link to='' className='text-blue-500'>Privacy Policy</Link></p>
    </div>
  )
}
